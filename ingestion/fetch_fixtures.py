...
    if not fixtures:
        print(f"⚠️ Aucune rencontre NS à venir pour ligue {league_id}")
        continue

    match_date = fixtures[0]["fixture"]["date"][:10]
    out = f"data/raw/fixtures_{league_id}_{match_date}.json"
    with open(out, "w") as f:
        json.dump(resp, f, indent=2)
    print(f"✅ Ligue {league_id} – {len(fixtures)} fixture(s) sauvegardée(s)")
